  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className='App-header title'>Swachh Desi</h1>
        <nav className="site-nav">
            <ul className="mainnav" >
              <li ><a href="/Home">Home</a></li>
              <li  ><a href="/">Login</a></li>
              <li  ><a href="/CreatedIncidents">Created Incidents</a></li>
              <li  ><a href="/ParticipatedIncidents">Participated Incidents</a></li>
        ...
        <div className='App-body'>
          <BrowserRouter>
              ...
              <Route path="/AddIncident" exact component={() => <AddIncident />} />
              ...
              <Route path="/ParticipatedIncidents" component={ParticipatedIncidents} />
          </BrowserRouter>
        </div>
